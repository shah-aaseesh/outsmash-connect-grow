                  ...
                  <div className="space-y-4 py-2">
                    <div className="px-3 py-2">
                      ...
                      <div className="space-y-1">
                        <button className="w-full flex items-center py-2 px-4 rounded-md bg-primary/10 text-primary font-medium">
                          <span>Feed</span>
                        </button>
                        <button className="w-full flex items-center py-2 px-4 rounded-md hover:bg-accent text-muted-foreground hover:text-foreground">
